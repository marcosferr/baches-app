...
export function PublicMapComponent({
  ...
  useEffect(() => {
    ...
    reports.forEach(report => {
      ...
      detailsButton.className = 'bg-primary text-white px-3 py-1 rounded text-sm mt-2 flex items-center justify-center w-full';
      detailsButton.innerHTML = 'Ver detalles <svg class="ml-1" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>';
  ...
  useEffect(() => {
    ...
    if (marker && selectedReport.location) {
      marker.openPopup();
      map.setView([selectedReport.location.lat, selectedReport.location.lng], 16);
    }
  }, [map, selectedReport]);
