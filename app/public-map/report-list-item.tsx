...
export function ReportListItem({ report, onClick, isSelected = false }: ReportListItemProps) {
  // Format date
    ...
    >
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-muted-foreground">Reportado el {formatDate(report.date_created)}</p>
        </div>
      </div>
    </div>
  )
