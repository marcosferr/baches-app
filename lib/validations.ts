...
export const createReportSchema = z.object({
  ...
  severity: z.enum(["LOW", "MEDIUM", "HIGH"], {
    errorMap: () => ({ message: "La gravedad debe ser: leve, moderada o alta" }),
  }),
...
export const createCommentSchema = z.object({
  ...
  text: z.string().min(1, "El comentario no puede estar vacío").max(500, "El comentario es demasiado largo"),
})
